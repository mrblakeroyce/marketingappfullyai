...
export const industryModes = [
  {
    ...
    brain: ["maintenance urgency", "fleet reliability", "trust", "easy booking"],
  },
  {
    id: "restaurant",
    name: "Restaurant",
    ...
    brain: ["cravings", "time-sensitive offers", "hospitality", "orders"],
  },
  {
    id: "barbershop",
    name: "Barbershop",
    ...
    brain: ["confidence", "style", "booking urgency", "neighborhood loyalty"],
  },
  {
    id: "general",
    name: "Local Business",
    ...
    brain: ["clear offers", "local trust", "simple CTAs", "community"],
  },
];
...
export const scheduledPosts = [
  {
    ...
    time: "5:00 PM",
    image: "🍻",
    caption: "Happy hour starts at 5:00. Stop in after work and bring a friend.",
  },
  {
    id: "sched-2",
    ...
    time: "9:00 AM",
    image: "🚚",
    caption: "Keep every vehicle in your fleet road-ready with easy local service.",
  },
  {
    id: "sched-3",
    ...
    time: "11:30 AM",
    image: "🛢️",
    caption: "Weekend oil change special for local drivers. Book before slots fill.",
  },
];
